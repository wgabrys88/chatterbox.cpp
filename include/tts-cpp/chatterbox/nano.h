...
inline constexpr int N_PREDICT = 2000;
...
inline constexpr int REPEAT_LAST_N = 200;
inline constexpr int RAS_WINDOW = 10;
inline constexpr float RAS_TAU = 0.1f;
inline constexpr int CFM_STEPS = 2;
inline constexpr int SILENCE_TOKEN = 4299;
inline constexpr int SILENCE_COUNT = 15;
}
